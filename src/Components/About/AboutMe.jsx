  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto" >
        <h2 data-aos="fade-up" className="text-3xl lg:text-4xl text-center font-bold text-blue-600 mb-8">
          About Me
        </h2>
        ...
        <p data-aos="fade-up"
          data-aos-delay="200" className="text-lg  leading-relaxed mb-6">
        ...
        <p data-aos="fade-up"
          data-aos-delay="300" className="text-lg  leading-relaxed mb-6">
        ...
        <p data-aos="fade-up"
          data-aos-delay="400" className="text-lg  leading-relaxed mb-6">
