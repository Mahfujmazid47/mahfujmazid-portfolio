...
const Hero = () => {
 return (
    <section id="home" className="bg-gradient-to-r from-primary/5 to-secondary/5 py-28 px-6 lg:px-20">
        ...
        <div className="flex justify-center" data-aos="zoom-in">
          <div className="relative">
            <img
              ...
              alt="Profile"
              className="rounded-full h-[500px] object-center border-4 border-white shadow-lg hover:scale-105 transition-transform duration-300"
            />
            <div className="absolute -bottom-4 -right-4 bg-gradient-to-r from-sky-400 to-blue-600 text-white px-4 py-2 rounded-full shadow-md text-sm font-semibold">
              Available for Hire
            </div>
          </div>
        </div>
